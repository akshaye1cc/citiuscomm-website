...
/* ─── Office Data — corrected lat/lng positions ───────────── */
const CITIES: Record<string, Office> = {
  mumbai: {
    id: "mumbai", city: "Mumbai",
    left: "70.24%", top: "42.40%",          // 19.08°N  72.88°E
  ...
  delhi: {
    id: "delhi", city: "Delhi",
    left: "71.45%", top: "37.11%",          // 28.61°N  77.21°E
  ...
  kolkata: {
    ...
    left: "74.54%", top: "40.46%",          // 22.57°N  88.36°E
    isHQ: false, country: "india",
  ...
  nepal: {
    id: "nepal", city: "Nepal",
    left: "73.70%", top: "37.61%",          // 27.71°N  85.31°E
  ...
  dubai: {
    id: "dubai", city: "Dubai",
    left: "65.35%", top: "39.00%",          // 25.20°N  55.27°E
  ...
  singapore: {
    ...
    left: "78.84%", top: "49.62%",          // 1.35°N  103.82°E
  ...
  tokyo: {
    id: "tokyo", city: "Tokyo",
    left: "88.80%", top: "33.17%",          // 35.69°N  139.69°E
...
/* ─── Clusters — pin anchor = weighted center of cities ──── */
const CLUSTERS: Record<string, Cluster> = {
  india: {
    label: "India", cities: ["mumbai", "delhi", "kolkata"],
    left: "72.00%", top: "40.00%",   // center of the 3 Indian cities
  },
  nepal: {
    label: "Nepal", cities: ["nepal"],
    left: "73.70%", top: "37.61%",
  },
  uae: {
    label: "Dubai", cities: ["dubai"],
    left: "65.35%", top: "39.00%",
  },
  singapore: {
    label: "Singapore", cities: ["singapore"],
    left: "78.84%", top: "49.62%",
  },
  japan: {
    label: "Tokyo", cities: ["tokyo"],
    left: "88.80%", top: "33.17%",
  },
};
...
const SidePanel = ({
  ...
  if (!countryId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px] rounded-2xl border-2 border-dashed border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] p-8 text-center gap-4">
        <div className="w-14 h-14 rounded-full bg-primary/10 dark:bg-primary/15 flex items-center justify-center text-primary">
          <GlobeIcon />
        </div>
        <div>
          <p className="text-sm font-bold text-gray-600 dark:text-white/50 mb-1">
            Explore Our Offices
          </p>
  ...
  return (
    <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-dark overflow-hidden shadow-xl">
      {/* Header */}
      <div className="relative px-5 py-4 bg-gradient-to-r from-primary to-primary/80 overflow-hidden">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            ...
            <h4 className="text-white text-lg font-bold">{cluster.label}</h4>
          </div>
          <button
            onClick={onClose}
          ...
          <div key={office.id} className="p-5">
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                {office.isHQ && (
                  <span className="bg-primary text-white text-[9px] font-extrabold tracking-wider px-2 py-0.5 rounded-full">
                    HQ
                  </span>
                )}
              </div>
              <a
                ...
                className="flex items-center gap-1 text-[10px] font-semibold text-primary border border-primary/25 rounded-lg px-2.5 py-1 hover:bg-primary/5 transition-colors"
              >
                Map <ExtIcon />
              </a>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-white/[0.03] rounded-xl p-3 mb-3">
              <p className="text-[11px] text-gray-500 dark:text-white/45 leading-relaxed whitespace-pre-line">
                {office.address}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 text-[11px] text-gray-500 dark:text-white/45">
                <div className="w-5 h-5 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center shrink-0">
                  <PhoneIcon />
                </div>
...
const MapPin = ({
  ...
  const pinW = isIndia ? 28 : 22;
  const pinH = isIndia ? 38 : 30;
    ...
    >
      <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <span style={{
          position: "absolute",
          top: "30%", left: "50%",
          width: pinW + 14, height: pinW + 14,
          marginLeft: -(pinW + 14) / 2,
          marginTop: -(pinW + 14) / 2,
          borderRadius: "50%",
          background: "#4A6CF7",
          opacity: 0,
          animation: isActive ? "none" : "mapPulse 2.4s ease-out infinite",
          pointerEvents: "none",
        }} />
        ...
        <svg
          ...
          style={{
            filter: isActive
              ? "drop-shadow(0 0 8px rgba(74,108,247,0.7)) drop-shadow(0 3px 6px rgba(0,0,0,0.3))"
              : "drop-shadow(0 2px 5px rgba(0,0,0,0.3))",
            transform: isActive ? "scale(1.3) translateY(-3px)" : "scale(1)",
            transition: "transform 0.22s cubic-bezier(0.34,1.56,0.64,1), filter 0.2s",
          }}
        >
          <path
            d="M14 0C8.48 0 4 4.48 4 10C4 18.5 14 36 14 36C14 36 24 18.5 24 10C24 4.48 19.52 0 14 0Z"
            fill={isActive ? "#3355d4" : "#4A6CF7"}
          />
          <circle cx="14" cy="10" r="5.5" fill="white"/>
          {isIndia && <circle cx="14" cy="10" r="2.5" fill="#4A6CF7"/>}
        </svg>
        ...
        <div style={{
          ...
          border: isActive ? "1px solid #4A6CF7" : "1px solid rgba(74,108,247,0.2)",
          borderRadius: 5,
          padding: "2px 6px",
          pointerEvents: "none",
          ...
          {cluster.cities.length > 1 && (
            <span style={{ marginLeft: 3, opacity: 0.6 }}>({cluster.cities.length})</span>
          )}
        </div>
      </div>
    </div>
...
const StatsBar = () => (
  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
    {[
      ...
      <div key={label} className="rounded-xl bg-gray-50 dark:bg-white/[0.03] border border-gray-100 dark:border-white/8 p-4 text-center">
    ...
    <div style={{ position: "relative", width: "100%", aspectRatio: "1 / 1" }}>
      ...
      <img
        ...
        style={{
          ...
          borderRadius: 16,
          filter: isDark
            ? "invert(1) hue-rotate(180deg) brightness(0.45) saturate(0.6)"
      ...
      {/* Arc lines from Mumbai HQ to all other cities */}
      <svg
        viewBox="0 0 626 626"
      ...
      >
        <defs>
          <marker id="arrow" markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" orient="auto">
            <circle cx="2.5" cy="2.5" r="2" fill="#4A6CF7" opacity="0.7"/>
          </marker>
        </defs>
      ...
      <button
        ...
        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border transition-all duration-200 ${
          activeCountry === id
            ...
            : "bg-white dark:bg-white/5 text-gray-600 dark:text-white/50 border-gray-200 dark:border-white/10 hover:border-primary/40 hover:text-primary dark:hover:text-primary"
        }`}
      >
        <svg width="8" height="10" viewBox="0 0 10 14" fill="none">
          <path d="M5 0C2.24 0 0 2.24 0 5c0 3.75 5 9 5 9s5-5.25 5-9c0-2.76-2.24-5-5-5zm0 7a2 2 0 110-4 2 2 0 010 4z"
            fill={activeCountry === id ? "white" : "#4A6CF7"} opacity={activeCountry === id ? 1 : 0.7}/>
        </svg>
        {c.label}
        {c.cities.length > 1 && (
          <span className={`${activeCountry === id ? "opacity-70" : "opacity-45"}`}>
            ×{c.cities.length}
          </span>
        )}
      </button>
...
export default function Contact() {
  ...
  const toggle = (id: string) => setActiveCountry(prev => prev === id ? null : id);
  ...
  return (
    <section className="relative py-16 md:py-20 lg:py-28">
      <div className="container">
        ...
        <div
          ref={wrapperRef}
          className="shadow-three dark:bg-gray-dark relative z-10 overflow-visible rounded-2xl bg-white p-5 md:p-7"
        >
          <div className="mb-5 flex items-center justify-between flex-wrap gap-2">
            <div>
              <h3 className="text-base font-bold text-black dark:text-white">Global Presence</h3>
              <p className="text-xs text-gray-500 dark:text-white/40 mt-0.5">Click a pin to explore office details</p>
            </div>
        ...
        {/* ── Bottom CTA ── */}
        <div className="mt-12 rounded-2xl bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 dark:from-primary/10 dark:via-primary/15 dark:to-primary/10 border border-primary/15 dark:border-primary/20 p-8 text-center">
