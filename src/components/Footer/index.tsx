        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4 lg:gap-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <a
              ...
              aria-label="LinkedIn"
              className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition-colors hover:border-primary hover:text-primary dark:border-gray-700 dark:text-gray-400"
            >
          ...
          {/* Col 2: Company */}
          <div>
            <h4 className="mb-5 text-sm font-semibold uppercase tracking-wider text-black dark:text-white">
              Company
            </h4>
            <ul className="space-y-3">
              {companyLinks.map(({ label, href }) => (
                <li key={label}>
                  <Link
                    href={href}
                    className="text-sm text-gray-500 transition-colors hover:text-primary dark:text-gray-400 dark:hover:text-primary"
                  >
                    {label}
                  </Link>
                </li>
